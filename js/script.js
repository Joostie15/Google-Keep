...
function loadingStatus() {
   if (loading == true) {
     imgStatus.setAttribute("src","images/donecloud.svg");
   } else {
     imgStatus.setAttribute("src","images/loading.svg");
   }
 }
...
// List ordering vertical/horizontal
  ...
  sorting.addEventListener("click", function () {
    ...
    if (sw == 0) {
      sorting.setAttribute("src","images/sortVert.svg");
      sw = 1;
      hor = true;
      ...
      sorting.setAttribute("src","images/sortHor.svg");
      sw = 0;
      hor = false;
      // Loop trough all the list
      for (var z = 0; z < articles.length; z++) {
